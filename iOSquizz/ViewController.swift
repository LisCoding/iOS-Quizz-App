...
class ViewController: UIViewController {
    ...
    @IBAction func nextButton(_ sender: UIButton) {
        ...
        else {   // else set currentQuestion to 0
            currentQuestion = 0
        }
         updateUI()
    ...
    @IBAction func answserButton(_ sender: UIButton) {
//        anwserLabel.isHidden = true
        // if answerLabel is not hidden, then make it hidden
        if anwserLabel.isHidden != true {
            anwserLabel.isHidden = true
        }
        // else set it not hidden
        else {
             anwserLabel.isHidden = false
        }
    ...
    func updateUI() {
        ...
        anwserLabel.text = quizBank[currentQuestion].1
